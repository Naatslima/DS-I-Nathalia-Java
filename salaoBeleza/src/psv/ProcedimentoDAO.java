        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    pb.setTelefone(rs.getString(2));
                    pb.setLimpezaDePele(rs.getString(3));
                    pb.setUnhaGel(rs.getString(4));
                    pb.setUnhaFibra(rs.getString(5));
                    pb.setPodologia(rs.getString(6));
                    pb.setEscovaCabelo(rs.getString(7));
                    pb.setPinturaCabelo(rs.getString(8));
                    pb.setLuzesCabelo(rs.getString(9));
                    pb.setCorteCabelo(rs.getString(10));
                    pb.setMassagem(rs.getString(11));
                    pb.setDrenagemLinfatica(rs.getString(12));
                    pb.setBanhoDeLama(rs.getString(13));
